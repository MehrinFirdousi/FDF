...
/*   Updated: 2022/12/20 21:43:59 by mfirdous         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * 		  and will track the number of words
 * 
 * @param s String to be split 
 * @param c Array of characters where each single character is a separator,
 *			if found in the string, will be used to split
